...
plot SAIDAS_CSV."/L3.csv" u 1:2 w lines smooth unique title 'naoOpt', \
    SAIDAS_CSV."/L3.csv" u 1:6 w lines smooth unique title 'opt'
...
plot SAIDAS_CSV."/L3.csv" u 1:3 w lines smooth unique title 'naoOpt', \
    SAIDAS_CSV."/L3.csv" u 1:7 w lines smooth unique title 'opt'
...
plot SAIDAS_CSV."/L3.csv" u 1:4 w lines smooth unique title 'naoOpt', \
    SAIDAS_CSV."/L3.csv" u 1:8 w lines smooth unique title 'opt'
...
plot SAIDAS_CSV."/L3.csv" u 1:5 w lines smooth unique title 'naoOpt', \
    SAIDAS_CSV."/L3.csv" u 1:9 w lines smooth unique title 'opt'
...
plot SAIDAS_CSV."/L2CACHE.csv" u 1:2 w lines smooth unique title 'naoOpt', \
    SAIDAS_CSV."/L2CACHE.csv" u 1:6 w lines smooth unique title 'opt'
...
plot SAIDAS_CSV."/L2CACHE.csv" u 1:3 w lines smooth unique title 'naoOpt', \
    SAIDAS_CSV."/L2CACHE.csv" u 1:7 w lines smooth unique title 'opt'
...
plot SAIDAS_CSV."/L2CACHE.csv" u 1:4 w lines smooth unique title 'naoOpt', \
    SAIDAS_CSV."/L2CACHE.csv" u 1:8 w lines smooth unique title 'opt'
...
plot SAIDAS_CSV."/L2CACHE.csv" u 1:5 w lines smooth unique title 'naoOpt', \
    SAIDAS_CSV."/L2CACHE.csv" u 1:9 w lines smooth unique title 'opt'
...
plot SAIDAS_CSV."/TIME.csv" u 1:2 w lines smooth unique title 'naoOpt', \
    SAIDAS_CSV."/TIME.csv" u 1:6 w lines smooth unique title 'opt'
...
plot SAIDAS_CSV."/TIME.csv" u 1:3 w lines smooth unique title 'naoOpt', \
    SAIDAS_CSV."/TIME.csv" u 1:7 w lines smooth unique title 'opt'
...
plot SAIDAS_CSV."/TIME.csv" u 1:4 w lines smooth unique title 'naoOpt', \
    SAIDAS_CSV."/TIME.csv" u 1:8 w lines smooth unique title 'opt'
...
plot SAIDAS_CSV."/TIME.csv" u 1:5 w lines smooth unique title 'naoOpt', \
    SAIDAS_CSV."/TIME.csv" u 1:9 w lines smooth unique title 'opt'
